...
//4) Unlike pop and shift, push and unshift require arguments inside the (). Add the items 1138 and 
// ‘20 meters’ to the the array - the number at the start and the string at the end. 
...
console.log(`Finale array: ${cargoHold} and its length: ${cargoHold.length}`)
